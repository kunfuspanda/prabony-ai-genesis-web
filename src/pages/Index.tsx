...
import { Brain, Zap, Shield, Users, ArrowRight, Star, CheckCircle } from "lucide-react";
  ...
  const pricingPlans = [
    {
      ...
      price: "$29",
      period: "/month",
      features: ["10,000 AI queries", "Basic analytics", "Email support", "API access"],
      popular: false
    },
    {
      name: "Professional",
      price: "$99",
      period: "/month",
      features: ["100,000 AI queries", "Advanced analytics", "Priority support", "Custom integrations", "Team collaboration"],
      popular: true
    },
    {
      name: "Enterprise",
      price: "Custom",
      period: "",
      features: ["Unlimited queries", "Custom AI models", "Dedicated support", "On-premise deployment", "SLA guarantee"],
      popular: false
    }
  ];
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-2xl font-bold">Prabony AI</span>
              </div>
          ...
          <div className="text-center text-gray-400">
            <p>&copy; 2024 Prabony AI. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
